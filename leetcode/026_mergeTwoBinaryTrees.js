...
let mergeTrees = function(root1, root2) {
  // if root1 and root2 are null, return
  // if root1 is null, set root1 as root2
  // if root2 is null, set root2 as root1
  // else root1 is sum of root1 val and root2 val
  // mergeTrees root1.left, root2.left, and right
  // return root1?
